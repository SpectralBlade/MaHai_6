...
class Item:
    def __init__(self, item_id: str, name: str, rarity: str, sell_cost: int,
                 buy_cost: int = 0, max_stack: int = 1):
...
class Equipment(Item):
    def __init__(self, item_id: str, name: str, rarity: str, sell_cost: int, stats_bonus: dict,
                 enchantable: bool = False):
        super().__init__(item_id, name, rarity, sell_cost, max_stack=1)
...
class Consumable(Item):
    def __init__(self, item_id: str, name: str, rarity: str, sell_cost: int,
        ...
        super().__init__(item_id, name, rarity, sell_cost, max_stack=99)
...
class QuestItem(Item):
    def __init__(self, item_id: str, name: str):
        super().__init__(item_id, name, rarity="Quest", sell_cost=0, max_stack=1)
